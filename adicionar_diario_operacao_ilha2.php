...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $usina = $_POST['usina'];
    $ilha = 'Ilha 2'; // Definindo a ilha como Ilha 2
...
<head>
    ...
    <title>Adicionar Registro - Diário de Operação - Ilha 2</title>
</head>
<body>
    <div class="container">
        <h2>Adicionar Registro - Diário de Operação - Ilha 2</h2>
        <form action="adicionar_diario_operacao_ilha2.php" method="POST" class="form-group">
        ...
        <a href="diario_operacao_ilha2.php">Voltar</a>
    </div>
</body>
</html>
