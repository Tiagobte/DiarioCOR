...
<head>
    ...
    <title>Editar Registro - Diário de Operação Ilha 1</title>
</head>
<body>
    <div class="container">
        <h2>Editar Registro - Diário de Operação Ilha 1</h2>
        <form action="editar_diario_operacao_ilha1.php?id=<?php echo $id; ?>" method="POST" class="form-group">
